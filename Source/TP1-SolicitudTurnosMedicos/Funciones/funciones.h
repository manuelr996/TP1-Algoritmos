...
void ProcEspecialidad(std::ifstream &archivoEspecialidades, Especialidad especialidades[], int &cantEspecialidades);  // Descarga archivo Especialidades.
void ProcTurnosDiaHora(std::ifstream &archivoTDH, Turno turnos[], int &);  // Descarga archivo TurnosDiaHora.
